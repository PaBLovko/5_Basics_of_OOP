package by.epam.tasks.fifth.action;

import by.epam.tasks.fifth.builder.CandyPresentBuilder;
import by.epam.tasks.fifth.builder.PresentDirector;
import by.epam.tasks.fifth.entity.*;
...
public class Client {
    ...
    private static List<Product> readCandyFile() {
        ...
        String filePath = "src\\by\\epam\\tasks\\fifth\\resources\\candies.txt";
        try {
